...
### 24.08.12
* Spring legacy project는 있으나 Spring mvc project가 없음 - 구글링 결과 스프링 프레임워크의 워크스페이스 \.metadata\.plugins\org.springsource.ide.eclipse.commons.content.core 폴더 내에 https-content.xml 파일이 없어서 발생하는 문제 -> 해결함

### 24.08.17
#### 스프링 프로젝트 개발과정 
1. 스프링에서 프로젝트 생성(Spring Legacy Project -> Spring MVC Project, 없으면 24.08.12 확인) 
2. 서블릿 설정하기
